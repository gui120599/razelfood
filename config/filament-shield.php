...
return [
    ...
    */
    ...
    'custom_permissions' => [
        'manage_order_status' => 'Gerenciar status do pedido',
        'mark_order_delivered' => 'Confirmar entrega do pedido',
        'edit_order_advanced_status' => 'Editar pedido em etapa avançada',
    ],

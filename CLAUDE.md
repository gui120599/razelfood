...
Sistema de pedidos online multi-tenant para restaurantes/pizzarias PME (Razel Tec).
Stack: Laravel 12 + Livewire 3 + Filament 4 + Tailwind v4 + MySQL, seguindo a skill `laravel-dev`.

## Documentos de referência (ler antes de propor mudanças de escopo)
- `docs/requisitos-regras-negocio.md` — regras de negócio, requisitos funcionais, modelo comercial
- `docs/modelagem-middleware-multitenant.md` — schema de banco, middleware de tenant, guardrails técnicos
